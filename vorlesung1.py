...
''' In dieser Aufgabe sollen Sie zwei Klassen erstellen, die zusammenarbeiten, um ein Parkplatzverwaltungssystem zu modellieren. 
Die Klassen sind Fahrzeug und Parkplatz.
